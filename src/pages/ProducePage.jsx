...
const ProducePage = () => {
  ...
  function handleReview(e) {
    ...
    if (e.target[0].value != "") {
      ...
      postReview({ id: data.id, reviews: [...data.reviews, formData] });
      e.target.reset();
    }
  }
  let stars = [];
    ...
    <div className="my-10">
      <div className="max-sm:grid-cols-1 grid grid-cols-2 items-center gap-10">
        <div className="items-center">
          <div className="flex rounded-lg justify-center items-center bg-gradient-to-br from-black/40 to-black/10">
        ...
        {taps ? (
          <div>
            {data?.reviews.map((rev, i) => {
              return (
                <div className="my-12 grid gap-y-16" key={i}>
            ...
            <div className="my-16">
              ...
              <div className="">
                <form
                  className="grid mt-10 items-center"
